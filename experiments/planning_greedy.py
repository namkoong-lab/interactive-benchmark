#!/usr/bin/env python3
"""
Greedy Variant of the Planning Experiment.

The model is explicitly told to ask questions that would immediately eliminate 
the most products remaining in the pool. 
"""
