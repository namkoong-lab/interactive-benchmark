#!/usr/bin/env python3
"""
Random Baseline: Making a Random Recommendation
"""
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Run the Random Baseline experiment.")
    ...
    parser.add_argument('--output_dir', type=str, default="baseline_random_results",
