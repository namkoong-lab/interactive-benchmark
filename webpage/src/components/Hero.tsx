...
export default function Hero() {
  ...
  const navItems = [
    ...
    { name: 'Paper', href: 'https://arxiv.org/abs/XXXX.XXXXX', icon: PaperIcon, external: true },
    { name: 'Code', href: 'https://github.com/lucas100601/agent-thesis.git', icon: CodeIcon, external: true },
    { name: 'Submit', href: '/submit', icon: SubmitIcon, external: false },
    { name: 'Leaderboard', href: '/leaderboard', icon: LeaderboardIcon, external: false },
  ]
        ...
        <div className="text-center">
          ...
          <div className="mb-8">
            <p className="text-lg md:text-xl text-white/90 font-medium">
              Author Name<sup className="text-sm">1</sup>, Collaborator Name<sup className="text-sm">2</sup>, Another Author<sup className="text-sm">1,3</sup>
            </p>
            <p className="text-base md:text-lg text-white/75 mt-3">
              <sup className="text-xs">1</sup>Institution Name · <sup className="text-xs">2</sup>University Name · <sup className="text-xs">3</sup>Research Lab
            </p>
          </div>
        </div>
      </div>
