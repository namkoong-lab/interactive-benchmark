...
def run_batch_experiments():
    ...
    experiment_script_module = 'experiments.planning_no_strat'
    experiment_script_path = os.path.join('experiments', 'planning_no_strat.py')
    ...
    for i, seed in enumerate(seeds):
        ...
        output_dir = (
            f"fixed_questions_results_{config['num_categories']}_{config['model']}_"
    ...
    results_filename = f"fixed_questions_experiment_{config['model']}_{config['feedback_type']}.json"    
