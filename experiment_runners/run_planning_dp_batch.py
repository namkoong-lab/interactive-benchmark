...
def run_batch_experiments():
    ...
    experiment_script_module = 'experiments.planning_dp'
    experiment_script_path = os.path.join('experiments', 'planning_dp.py')
    ...
    for i, seed in enumerate(seeds):
        ...
        output_dir = (
            f"fixed_questions_dp_results_{config['num_categories']}_{config['model']}_"
    ...
    results_filename = f"fixed_questions_dp_experiment_{config['model']}_{config['feedback_type']}.json"    
