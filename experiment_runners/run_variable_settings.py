#!/usr/bin/env python3
"""
Run Variable Settings Experiment with incremental checkpointing to prevent data loss.
"""
...
from experiments.variable_settings import run_experiment3
...
if __name__ == "__main__":
    ...
    print(f"python 'experiment runners/run_variable_settings.py' --resume_from experiment3_results_with_checkpoints/checkpoint_episode_XXX_gemini-2.5-pro_persona.json")
