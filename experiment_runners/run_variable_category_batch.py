...
def run_batch_experiments():
    ...
    experiment_script_path = os.path.join('experiments', 'variable_category.py')
    ...
    for i, seed in enumerate(seeds):
        ...
        output_dir = (
            f"experiment1_results_{config['num_categories']}_{config['model']}_"
        ...
        command = [
            ...
            'python', '-m', 'experiments.variable_category',
    ...
    # --- Write summary file ---
    summary_filename = (
        f"experiment1_summary_{config['num_categories']}_{config['model']}_"
        f"{config['feedback_type']}_{config['context_mode']}_"
