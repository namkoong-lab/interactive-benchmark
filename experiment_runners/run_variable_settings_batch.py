...
This script executes pipeline/experiment3.py multiple times with different seeds,
...
def run_batch_experiments():
    ...
    # experiment_script_path = os.path.join('pipeline', 'experiment3.py')
    experiment_script_path = os.path.join('experiments', 'variable_settings.py')
    ...
    for i, seed in enumerate(seeds):
        ...
        output_dir = (
            f"experiment3_results_{config['total_episodes']}_{config['model']}_"
        ...
        command = [
            # 'python','-m', 'pipeline.experiment3',
            'python', '-m', 'experiments.variable_settings',
    ...
    results_filename = f"experiment3_results_{config['model']}_{config['feedback_type']}.json"
    ...
    # --- Write summary file ---
    summary_filename = (
        f"experiment3_summary_{config['num_personas']}_{config['model']}_"
        f"{config['feedback_type']}_{config['context_mode']}_"
