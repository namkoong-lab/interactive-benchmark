...
def run_batch_experiments():
    ...
    experiment_script_path = os.path.join('experiments', 'baseline_random.py')
    ...
    for i, seed in enumerate(seeds):
        ...
        output_dir = (
            f"baseline_random_exp1_results_{config['num_categories']}_{seed}"
        )
    ...
    results_filename = f"baseline_random_final_none.json"
    ...
    # --- Write summary file ---
    summary_filename = (
        f"baseline_random_exp1_summary_{config['num_categories']}.json"
    )
