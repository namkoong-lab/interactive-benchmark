...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Run Baseline 5 with checkpointing.")
    parser.add_argument("--resume_from", type=str, default=None, help="Path to a checkpoint file to resume from.")
    args = parser.parse_args()

    print("Running Baseline Experiment: No Tricks + Everything in Context")
